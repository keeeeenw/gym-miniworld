...
class FourRoomsMeta(MiniWorldEnv):
    """
    Classic four rooms environment with a twist for meta learning.
    The agent must reach the box with random color to get a reward.
    """
    ...
    def _gen_world(self):
        ...
        # Use a random color for meta learning
